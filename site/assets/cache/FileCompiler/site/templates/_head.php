<!DOCTYPE html>
<html lang="<?php echo mp_get_language($user); ?>">
<head>
	<meta charset="utf-8">
 ...
 include_once(\ProcessWire\wire('files')->compile(\ProcessWire\wire("config")->paths->root . 'site/templates/_headcustomfiles.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
	?>
...
<div class="nav fixed sticky" id="main-nav">
    ...
    <div class="nav-right">
		<?php
 include_once(\ProcessWire\wire('files')->compile(\ProcessWire\wire("config")->paths->root . 'site/templates/_langswitch.php',array('includes'=>true,'namespace'=>true,'modules'=>true,'skipIfNamespace'=>true)));
		?>
        <a class="nav-item menu-toggle" href="#menu">
            <span class="icon icon-menu"></span> <span class="text"><?php echo \ProcessWire\__('Menu'); ?></span>
        </a>
    </div>
</div>
