	...
	<div class="hero is-light has-text-centered" id="memberships">
		<div class="hero-body">
			<div class="container">
				...
				<h5 class="title is-5"><?php echo \ProcessWire\__('We are member of'); ?></h5>
...
<div id="footer">
    ...
    <div class="section is-medium is-dark">
        ...
        <h2 class="title is-2 has-text-centered">
			<?php echo \ProcessWire\__('Create Your Online Success'); ?>
		</h2>
        <h5 class="subtitle is-5 has-text-centered">
			<?php echo \ProcessWire\__('Talk to us'); ?>
		</h5>
                ...
                <div class="column-content">
                    <div class="media">
                        ...
                        <div class="media-content">
                            <p>
                               ...
                               <br>
                                                Kulturos fabrikas, <?php echo \ProcessWire\__('4th floor'); ?>
                                                <br>
                                                <?php echo \ProcessWire\__('Bangu str.'); ?> 5A, LT-91250
                                                <?php echo \ProcessWire\__('Klaipeda'); ?>
                                                <br>
                                                <?php echo \ProcessWire\__('Lithuania'); ?>
                            </p>
                            <p><a href="https://goo.gl/maps/zMM8v6d7uY52" class="button is-outlined is-small" target="_blank"><span class="icon-pin"></span> <?php echo \ProcessWire\__('Open map'); ?></a></p>
                        </div>
                    </div>
                    ...
                    <div class="media">
                        ...
                        <div class="media-content">
                            ...
                            <p><a href="skype:memelpower.com?chat" class="button is-outlined is-small"><span class="icon-skype"></span> <?php echo \ProcessWire\__('Chat with us'); ?></a></p>
                        </div>
                    </div>
                    ...
                    <div class="media -is-hidden-tablet">
                       <div class="media-left">
                        ...
                        <div class="media-content">
                            <a href="/files/memelpower-kai-noack.vcf" class="button is-outlined is-primary"><?php echo \ProcessWire\__('Import contact'); ?> (.vcf)</a>
                        </div>
                    </div>
                </div>
